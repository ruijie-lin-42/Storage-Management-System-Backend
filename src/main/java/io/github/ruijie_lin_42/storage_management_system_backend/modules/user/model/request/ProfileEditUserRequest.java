...
@Data
@Schema(description = "Edit user request through profile page")
public class ProfileEditUserRequest {

    @NotNull
    @NotBlank
    @Size(min = UserConstraints.USERNAME_LENGTH_MIN, max = UserConstraints.USERNAME_LENGTH_MAX)
    @Schema(description = "Username, has to be unique in system after edit", example = "ZhangSan123")
    ...
    @Schema(description = "User's email address, not required to be unique, has to follow pattern xxx@xxx.com", example = "zhangsan123@whatevermail.com")
